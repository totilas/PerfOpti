...
for j, level in enumerate(levels):
    ...
    learner_groups = [
        [RRM() for _ in range(num_iter_average)]
    ]
...
cos = ['xkcd:wintergreen', "Blue", 'xkcd:bluegrey', "Green", 'xkcd:sky', "Red", "Yellow", "Purple", "Orange", "Pink", "Cyan", "Gray", "Brown"]
